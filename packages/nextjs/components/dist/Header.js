...
var NavLink = function (_a) {
    ...
    return (react_1["default"].createElement(link_1["default"], { href: href, passHref: true, className: (isActive ? "bg-secondary shadow-md" : "") + " hover:bg-secondary hover:shadow-md focus:bg-secondary py-1.5 px-3 text-sm rounded-full gap-2" }, children));
};
/**
 * Site header
 */
exports.Header = function () {
    ...
    var navLinks = (react_1["default"].createElement(react_1["default"].Fragment, null,
        ...
        react_1["default"].createElement("li", null,
            react_1["default"].createElement(NavLink, { href: "https://scobru.gitbook.io/universe/" },
                react_1["default"].createElement(outline_1.DocumentIcon, { className: "h-4 w-4" }),
                react_1["default"].createElement("h1", { className: "text-base font-semibold my-0" }, "Docs")))));
    return (react_1["default"].createElement("div", { className: "sticky lg:static top-0 navbar bg-base-100 min-h-0 flex-shrink-0 justify-between z-20" },
        react_1["default"].createElement("div", { className: "navbar-start w-auto lg:w-1/2" },
            ...
            react_1["default"].createElement(link_1["default"], { href: "/", passHref: true, className: "hidden lg:flex items-center gap-2 ml-4 mr-6" },
                react_1["default"].createElement("div", { className: "flex flex-col py-2" },
                    react_1["default"].createElement("span", { className: "font-bold text-xl" }, "\u25EF U N I V E R S E "),
                    react_1["default"].createElement("span", { className: "text-xs" }, "Decentralized Investment platform"))),
